...
namespace UserServiceTest
{
    public class UserControllerTest
    {
        ...
        public void Setup()
        {
            ...
            currentUserSourceMock.SetReturnsDefault(new UserDto() { Email = "admin@mail.ru" });
            ...
            userRepoMock.Setup(x => x.AddUser("user@mail.ru", "Password1", RoleId.USER)).Returns(_testGuid);
